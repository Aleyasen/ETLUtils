...
import freebase.api.entity.music.Artist;
import freebase.api.entity.music.Recording;
...
public class FreebaseAPIMusic {

    public static Properties properties = new Properties();
    public static String current_cursor = "";
    public static Sequence IDs = new Sequence();

    static Map<String, Integer> recording_map = new HashMap<>();
    static Map<String, Integer> artist_map = new HashMap<>();
...
//        getTopKActors(20);
    ...
    public static void filterByTopActors() {
        String suffix = ".2k";
        final Set<Integer> topActors = getTopKActors(12);
...
//            }
    ...
    private static List<Recording> encodeJSON(JSONArray results) {
        ...
        for (Object recordingObj : results) {
            ...
            Recording recording = new Recording(getId((String) recordingJObj.get("mid"), recording_map), (String) recordingJObj.get("mid"), (String) recordingJObj.get("name"));
            ...
            Artist artist = new Artist(getId((String) recorded_by.get("mid"), artist_map), (String) recorded_by.get("mid"), (String) recorded_by.get("name"));
    ...
    final static String ROOT_DIR = "C:/Data/freebase/music_results/";
...
//            System.out.println("mid=" + mid);
    ...
    private static void writeToFiles(List<Recording> recordings) {
...
//            System.out.println("Writing film = " + recording.getId() + " , " + recording.getMid() + " , " + recording.getName() + " , starring# = " + recording.getStarrings().size());
//            //film
//            film_str_all.append(recording.getId()).append(SEPERATOR).append(recording.getMid()).append(SEPERATOR).append(recording.getName()).append(NEWLINE);
//            film_str.append(recording.getId()).append(SEPERATOR).append(recording.getName()).append(NEWLINE);
//
//            //directedby
//            directedby_str.append(recording.getDirectedBy().getId()).append(NEWLINE);
//
//            //film-directedby
//            film_directedby_str.append(recording.getId()).append(SEPERATOR).append(recording.getDirectedBy().getId()).append(NEWLINE);
//
//            //film-director
//            film_director_str.append(recording.getId()).append(SEPERATOR).append(recording.getDirectedBy().getDirector().getId()).append(NEWLINE);
//
//            //director
//            director_str_all.append(recording.getDirectedBy().getDirector().getId()).append(SEPERATOR).append(recording.getDirectedBy().getDirector().getMid()).append(SEPERATOR).append(recording.getDirectedBy().getDirector().getName()).append(NEWLINE);
//            director_str.append(recording.getDirectedBy().getDirector().getId()).append(SEPERATOR).append(recording.getDirectedBy().getDirector().getName()).append(NEWLINE);
//
//            //director-directedby
//            director_directedby_str.append(recording.getDirectedBy().getDirector().getId()).append(SEPERATOR).append(recording.getDirectedBy().getId()).append(NEWLINE);
//
//        }

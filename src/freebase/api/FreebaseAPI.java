...
//        removeDuplicates(ACTOR_FILE);
//        removeDuplicates(FILM_FILE);
//        removeDuplicates(DIRECTOR_FILE);
//        removeDuplicates(STARRING_FILE);
...
//        getTopKActors(20);
    ...
    public static List getFilms(String fromDate, String toDate) {
        JSONArray results = FreebaseHelper.getJSON(fromDate, toDate);
        List<Film> films = FreebaseAPI.encodeJSON(results);
        return films;
    }

    final static String ROOT_DIR = "C:/freebase-dataset/";
